...
TEST_CASE("MockPerformanceSource satisfies IPerformanceSource interface",
          "[compile][drift]") {
    ...
    static_assert(!std::is_abstract_v<MockPerformanceSource>,
...
TEST_CASE("MoonrakerPerformanceSource satisfies IPerformanceSource interface",
          "[compile][drift]") {
    using namespace helix::perf;
    ...
    static_assert(!std::is_abstract_v<MoonrakerPerformanceSource>,
