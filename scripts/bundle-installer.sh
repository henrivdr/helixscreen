...
HEADER
    ...
    for module in common.sh platform.sh permissions.sh requirements.sh forgex.sh competing_uis.sh printer_seed.sh klipper_include.sh release.sh service.sh audio.sh moonraker.sh recovery.sh kiauh.sh uninstall.sh main.sh; do
